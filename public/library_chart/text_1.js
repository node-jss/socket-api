if (!function (n, t) {
        ...
        var y = [], u = n.document, v = y.slice, gi = y.concat, ti = y.push, lt = y.indexOf, at = {}, af = at.toString, ft = at.hasOwnProperty, f = {}, nr = "2.2.3", i = function (n, t) {
        ...
        var ve = /#.*$/, tf = /([?&])_=[^&]*/, ye = /^(.*?):[ \t]*([^\r\n]*)$/gm, pe = /^(?:GET|HEAD)$/, we = /^\/\//, rf = {}, yi = {}, uf = "*/".concat("*"), pi = u.createElement("a");
        pi.href = ct.href;
        i.extend({
            active: 0,
            lastModified: {},
        ...
        var o = {
            ...
            init: function (i) {
                var r = n.extend(o, i);
                return this.each(function () {
                    var i = n(this), f = i.attr("id"), e = n("<div><\/div>").attr("id", f + "-sticky-wrapper").addClass(r.wrapperClassName), u;
                    i.wrapAll(e);
    ...
    (function (n) {
        ...
        (function (n) {
            ...
            s.a = function () {
                ...
                return {
                    cc: ["authenticity_token", /^__RequestVerificationToken(_.*)?$/], q: function (n, t) {
                        ...
                        n = s.a.V(n);
                        for (var r = (n[0] && n[0].ownerDocument || t).createElement("div"), i = 0, u = n.length; i < u; i++)r.appendChild(s.$(n[i]));
                        return r
                    }, ua: function (n, t) {
                        for (var r, i = 0, f = n.length, u = []; i < f; i++)r = n[i].cloneNode(!0), u.push(t ? s.$(r) : r);
                        return u
                    }, da: function (n, t) {
                        ...
                        for (var r = s.a.V(n.getElementsByTagName("input")).concat(s.a.V(n.getElementsByTagName("textarea"))), f = "string" == typeof t ? function (n) {
                            return n.name === t
                        } : function (n) {
            ...
            s.b("utils.domNodeDisposal.removeDisposeCallback", s.a.F.pc), function () {
                var h = [0, "", ""], u = [1, "<table>", "<\/table>"], f = [3, "<table><tbody><tr>", "<\/tr><\/tbody><\/table>"], e = [1, "<select multiple='multiple'>", "<\/select>"], c = {
                    thead: u,
                    tbody: u,
                    tfoot: u,
                    tr: [2, "<table><tbody>", "<\/tbody><\/table>"],
                ...
                s.a.ma = function (n, u) {
                    ...
                    if (i) {
                        ...
                        (f = u) || (f = t);
                        var e = f.parentWindow || f.defaultView || r, v = s.a.$a(n).toLowerCase(), l = f.createElement("div"), a;
                ...
                s.a.Cb = function (t, r) {
                    if (s.a.ob(t), r = s.a.c(r), null !== r && r !== n)if ("string" != typeof r && (r = r.toString()), i)i(t).html(r); else for (var f = s.a.ma(r, t.ownerDocument), u = 0; u < f.length; u++)t.appendChild(f[u])
                }
            }();
            ...
            s.la.fn = {
                remove: function (n) {
                    for (var u, r = this.t(), i = [], f = "function" != typeof n || s.H(n) ? function (t) {
                        return t === n
                    } : n, t = 0; t < r.length; t++)u = r[t], f(u) && (0 === i.length && this.ga(), i.push(u), r.splice(t, 1), t--);
                        ...
                        if (r && !u) {
                            ...
                            switch (t) {
                                ...
                                case"splice":
                                    ...
                                    for (var e = 1 === h ? e : Math.min(t + (f[1] || 0), e), h = t + h - 2, o = Math.max(e, h), a = [], v = [], y = 2; t < o; ++t, ++y)t < e && v.push(c("deleted", n[t], t)), t < h && a.push(c("added", f[y], t));
                                    s.a.dc(v, a);
                                    break;
                                default:
                                    return
                ...
                s.j = {
                    u: function (t) {
                        ...
                        switch (s.a.A(t)) {
                            ...
                            case"select":
                                ("" === i || null === i) && (i = n);
                                for (var f = -1, u = 0, o = t.options.length, e; u < o; ++u)if (e = s.j.u(t.options[u]), e == i || "" == e && i === n) {
                                    f = u;
                                    break
                                }
            ...
            s.b("jsonExpressionRewriting.insertPropertyAccessorsIntoJson", s.h.Ua), function () {
                ...
                var i = t && "<!--test-->" === t.createComment("test").text, e = i ? /^\x3c!--\s*ko(?:\s+([\s\S]+))?\s*--\x3e$/ : /^\s*ko(?:\s+([\s\S]+))?\s*$/, o = i ? /^\x3c!--\s*\/ko\s*--\x3e$/ : /^\s*\/ko\s*$/, h = {
                    ul: !0,
                    ol: !0
                };
                s.f = {
            ...
            s.d.attr = {
                ...
                s.d.checked = {
                    after: ["value", "attr"], init: function (t, i, r) {
                        ...
                        if (h || e) {
                            var o = i(), u = h && s.a.c(o) instanceof Array, a = !(u && o.push && o.splice), c = u ? f() : n, y = e || u;
            ...
            s.d.options = {
                init: function (n) {
                    ...
                    var h = t.multiple, c = 0 != t.length && h ? t.scrollTop : null, u = s.a.c(i()), e = r.get("valueAllowUnset") && r.has("value"), p = r.get("optionsIncludeDestroyed"), l, f, o;
                    i = {};
                    f = [];
            ...
            s.f.Z.text = !0, function () {
                ...
                }, e = r.opera && r.opera.version && parseInt(r.opera.version()), i = r.navigator.userAgent, o = t(i.match(/^(?:(?!chrome).)*version\/([^ ]*) safari/i)), h = t(i.match(/Firefox\/([^ ]*)/));
            ...
            s.b("__tr_ambtns", s.Gb.Ec), function () {
                ...
                s.Ab = function (t, u, f, h, c) {
                    ...
                    if (c = c || "replaceChildren", h) {
                        var l = i(h);
                        return s.B(function () {
                            var n = u && u instanceof s.U ? u : new s.U(s.a.c(u)), r = o(t, n.$data, n), n = e(h, c, r, n, f);
...
!function (n, t) {
    ...
    function ku(n, t, i) {
        for (var f = Math.min(n.length, t.length), o = Math.abs(n.length - t.length), u = 0, r = 0; f > r; r++)(i && n[r] !== t[r] || !i && e(n[r]) !== e(t[r])) && u++;
        return u + o
    }
    ...
    function cf() {
        ...
        for (var i, r = [], u = [], t = [], n = 0; 12 > n; n++)i = it([2e3, n]), r.push(this.monthsShort(i, "")), u.push(this.months(i, "")), t.push(this.months(i, "")), t.push(this.monthsShort(i, ""));
    ...
    function br(n) {
        ...
        n._a = [];
        f(n).empty = !0;
        for (var i, u, s, r = "" + n._i, c = r.length, h = 0, o = of(n._f, n._locale).match(we) || [], e = 0; e < o.length; e++)u = o[e], i = (r.match(ts(u, n)) || [])[0], i && (s = r.substr(0, r.indexOf(i)), s.length > 0 && f(n).unusedInput.push(s), r = r.slice(r.indexOf(i) + i.length), h += i.length), ui[u] ? (i ? f(n).empty = !1 : f(n).unusedTokens.push(u), rs(u, i, n)) : n._strict && !i && f(n).unusedTokens.push(u);
    ...
    function bi(n) {
        var t = uf(n), i = t.year || 0, r = t.quarter || 0, u = t.month || 0, f = t.week || 0, e = t.day || 0, o = t.hour || 0, s = t.minute || 0, h = t.second || 0, c = t.millisecond || 0;
    ...
    function dr(n, t) {
        var r = (t || "").match(n) || [], f = r[r.length - 1] || [], i = (f + "").match(to) || ["-", 0, 0], u = +(60 * i[1]) + e(i[2]);
        return "+" === i[0] ? u : -u
    }
    ...
    function vh(n, t) {
        var u = n || h(), f = gr(u, this).startOf("day"), i = this.diff(f, "days", !0), r = -6 > i ? "sameElse" : -1 > i ? "lastWeek" : 0 > i ? "lastDay" : 1 > i ? "sameDay" : 2 > i ? "nextDay" : 7 > i ? "nextWeek" : "sameElse", e = t && (ht(t[r]) ? t[r]() : t[r]);
    ...
    function tu() {
        ...
        for (var f, e, o, s, h = [], i = [], r = [], t = [], n = 0; 7 > n; n++)f = it([2e3, 1]).day(n), e = this.weekdaysMin(f, ""), o = this.weekdaysShort(f, ""), s = this.weekdays(f, ""), h.push(e), i.push(o), r.push(s), t.push(e), t.push(o), t.push(s);
    ...
    function cv(n, t, i) {
        var r = lt(n).abs(), h = fi(r.as("s")), f = fi(r.as("m")), e = fi(r.as("h")), o = fi(r.as("d")), s = fi(r.as("M")), c = fi(r.as("y")), u = h < yt.s && ["s", h] || 1 >= f && ["m"] || f < yt.m && ["mm", f] || 1 >= e && ["h"] || e < yt.h && ["hh", e] || 1 >= o && ["d"] || o < yt.d && ["dd", o] || 1 >= s && ["M"] || s < yt.M && ["MM", s] || 1 >= c && ["y"] || ["yy", c];
    ...
    ve = Array.prototype.some ? Array.prototype.some : function (n) {
        for (var i = Object(this), r = i.length >>> 0, t = 0; r > t; t++)if (t in i && n.call(this, i[t], t, i))return !0;
        return !1
    };
    ...
    var nr, a, l = {}, ci = {}, we = /(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g, tr = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, ou = {}, ui = {}, be = /\d/, k = /\d\d/, ke = /\d{3}/, su = /\d{4}/, ir = /[+-]?\d{6}/, c = /\d\d?/, de = /\d\d\d\d?/, ge = /\d\d\d\d\d\d?/, rr = /\d{1,3}/, hu = /\d{1,4}/, ur = /[+-]?\d{1,6}/, fr = /[+-]?\d+/, vv = /Z|[+-]\d\d:?\d\d/gi, er = /Z|[+-]\d\d(?::?\d\d)?/gi, li = /[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i, cu = {}, lu = {}, nt = 0, ft = 1, rt = 2, v = 3, tt = 4, et = 5, ni = 6, yv = 7, pv = 8;
    ...
    var no = /D[oD]?(\[[^\[\]]*\]|\s+)+MMMM?/, wv = "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), bv = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"), kv = li, dv = li, gv = /^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?/, ny = /^\s*((?:[+-]\d{6}|\d{4})(?:\d\d\d\d|W\d\d\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?:\d\d(?:\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?/, ty = /Z|[+-]\d\d(?::?\d\d)?/, or = [["YYYYYY-MM-DD", /[+-]\d{6}-\d\d-\d\d/], ["YYYY-MM-DD", /\d{4}-\d\d-\d\d/], ["GGGG-[W]WW-E", /\d{4}-W\d\d-\d/], ["GGGG-[W]WW", /\d{4}-W\d\d/, !1], ["YYYY-DDD", /\d{4}-\d{3}/], ["YYYY-MM", /\d{4}-\d\d/, !1], ["YYYYYYMMDD", /[+-]\d{10}/], ["YYYYMMDD", /\d{8}/], ["GGGG[W]WWE", /\d{4}W\d{3}/], ["GGGG[W]WW", /\d{4}W\d{2}/, !1], ["YYYYDDD", /\d{7}/]], au = [["HH:mm:ss.SSSS", /\d\d:\d\d:\d\d\.\d+/], ["HH:mm:ss,SSSS", /\d\d:\d\d:\d\d,\d+/], ["HH:mm:ss", /\d\d:\d\d:\d\d/], ["HH:mm", /\d\d:\d\d/], ["HHmmss.SSSS", /\d\d\d\d\d\d\.\d+/], ["HHmmss,SSSS", /\d\d\d\d\d\d,\d+/], ["HHmmss", /\d\d\d\d\d\d/], ["HHmm", /\d\d\d\d/], ["HH", /\d\d/]], iy = /^\/?Date\((\-?\d+)/i;
    ...
    var ey = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), oy = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), sy = "Su_Mo_Tu_We_Th_Fr_Sa".split("_"), hy = li, cy = li, ly = li;
    ...
    var ot = Math.abs, ay = at("ms"), vy = at("s"), yy = at("m"), py = at("h"), wy = at("d"), by = at("w"), ky = at("M"), dy = at("y"), gy = gt("milliseconds"), np = gt("seconds"), tp = gt("minutes"), ip = gt("hours"), rp = gt("days"), up = gt("months"), fp = gt("years"), fi = Math.round, yt = {
        s: 45,
        m: 45,
        h: 22,
        d: 26,
    ...
    r.fn = r.prototype = {
        ...
        start: function (i, h) {
            var c = this, y = {
                ...
                transport: "auto",
                jsonp: !1
            }, d, p = c._deferral || n.Deferred(), w = t.document.createElement("a"), b, g;
    ...
    i.fn = i.prototype = {
        init: function (n, t) {
            ...
            var i = this, r = i.connection, s = n.makeArray(arguments).slice(1), c = e(s, o), f = {
                H: i.hubName,
                M: t,
                A: c,
